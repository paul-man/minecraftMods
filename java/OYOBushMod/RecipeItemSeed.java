...
public class RecipeItemSeed extends ItemFood implements IPlantable{
	...
	public RecipeItemSeed(int parHealAmount, float parSaturationModifier, Block parBlockPlant, Block parSoilBlock) {
